@extends('layouts.admin')
  @section('content')
    <div class="row">
        <div class="col-md-6"><h3 class="inner-tittle two">Category</h3></div>
        <div class="col-md-6" style="text-align:  right;"><a href="{{ route('category.create') }}" class="btn btn-info">Add New Category</a></div>
    </div>
