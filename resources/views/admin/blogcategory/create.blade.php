...
<div class="set-1">
    <div class="graph-2 general">
        <h3 class="inner-tittle two">Add New Category</h3>
        @if ($errors->any())
        ...
        <div class="grid-1">
            <div class="form-body">
                <form action="{{route('blogcategory.store')}}" method="post" id="category-form" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
