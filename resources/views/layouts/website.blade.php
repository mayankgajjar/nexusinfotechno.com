    ...
    <body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="social">
                                <li>
                                    <a href="https://www.facebook.com/Nexus.Infotechno.Inc/" class="Facebook" target="_blank">
                                        <i class="fab fa-facebook-f"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://twitter.com/nexusinfotechno" class="Twitter" target="_blank">
                                        <i class="fab fa-twitter"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/company/nexus-infotechno/" class="Linkedin" target="_blank">
                                        <i class="fab fa-linkedin-in"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/nexus.infotechno/" class="Instagram" target="_blank">
                                        <i class="fab fa-instagram"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://medium.com/@nexusinfotechno77" class="miduem" target="_blank">
                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <div class="main-menu">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <?php } else { ?>
                                <li  class="dropdown act-show">
                                    <a href="#">Service <span  class="ion-android-arrow-dropdown subActive"></span></a>
                                    <div class="dropdown-menu">
                                        <ul>
                                            <?php foreach ($service_menu as $smenu) { ?>
                                                <li class="dropdow linkdropdown">
                                                    <a href="{{url('/service/'.$smenu['slug'])}}">{{$smenu['title']}}</a>
                                                    
                                                    <?php if ($smenu['is_sub_menu'] == 'Y') { ?>
                                                        <span class="ion-android-arrow-dropdown subActive"></span>
        ...
        <footer id="footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="f_service">
                                ...
                                <p>0261 - 221222</p>
                                <p>
                                    <a href="https://www.facebook.com/Nexus.Infotechno.Inc/" class="facebook" target="_blank" style="margin-right: 15px;">
                                        <i class="fab fa-facebook-f"></i>
                                    </a>
                                    <a href="https://twitter.com/nexusinfotechno" class="twitter" target="_blank" style="margin-right: 15px;">
                                        <i class="fab fa-twitter"></i>
                                    </a>
                                    <a href="https://www.linkedin.com/company/nexus-infotechno/" class="linkedin" target="_blank" style="margin-right: 15px;">
                                        <i class="fab fa-linkedin-in"></i>
                                    </a>
                                    <a href="https://www.instagram.com/nexus.infotechno/" class="instagram" target="_blank" style="margin-right: 15px;">
                                        <i class="fab fa-instagram"></i>
                                    </a>
                                    <a href="https://medium.com/@nexusinfotechno77" class="miduem" target="_blank" style="margin-right: 15px;">
                                        <i class="fab fa-medium-m"></i>
                                    </a>
                                </p>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p class="copyright">Copyright: <span><script>document.write(new Date().getFullYear())</script></span> Design and Developed by <a href="http://nexusinfotechno.com/" target="_blank">Nexus Infotechno</a>. <br> 
                        </p>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                $("a .subActive").click(function(){
                    $("a .subActive").parents('li').toggleClass("subshow");
                });
                $(".linkdropdown .subActive").click(function(){
                    $(this).parents('.linkdropdown').toggleClass("subshow");
                });
            });
        </script>
        <script>
